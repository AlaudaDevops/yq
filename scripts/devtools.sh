...
# Build gosec from source with the active toolchain so its analyzers understand
# the current Go stdlib's export data version (prebuilt release binaries lag).
